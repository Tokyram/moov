...
class Course {
    ...
    static async findCompletedCoursesAll() {
        try {
            const result = await db.query(`
                SELECT 
                        course.id AS course_id,
                        course.passager_id, 
                        course.chauffeur_id, 
                        course.date_heure_depart AS depart,
                        course.adresse_depart_longitude AS longitude,
                        course.adresse_depart_latitude AS latitude,
                        course.adresse_depart,
                        course.adresse_arrivee_longitude,
                        course.adresse_arrivee_latitude,
                        course.adresse_arrivee,
