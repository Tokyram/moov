...
const Card: React.FC<CardProps> = ({ imageUrl, thumbUrl, title, status, destination, date, client, telephone, chauffeur, telephoneChauffeur, voiture }) => {
  return (
    <li>
