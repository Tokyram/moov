...
import './liste.css';
import { BannirChauffeurAdmin, DEFAULT_USER_PIC, getChauffeurs, getPhotoUser, supprimerChauffeurAdmin } from '../services/api';
  ...
  const [items, setItems] = useState<ItemProps[]>([]); // Liste des chauffeurs
    ...
    if (selectedItem !== null) {
      try {
        ...
        alert("Échec de la suppression du conducteur");
      }
    }
    closeModal();
  };
      ...
      <>
        {isDataLoading && (<Loader/>)}
        {
          ...
          <div className='containerClient'>
            ...
            {showAlert && (
              <CustomAlert message="Conducteur banni avec succès" onClose={closeAlert} />
              )}
